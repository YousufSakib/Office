...
function BookPackageView({ data, setPopupViewId }) {
  ...
  return (
    <div onClick={handleClose} className="bookPackageViewWrapper">
      <div className="bookPackageView" onClick={handlePopupClick}>
        <div className="row">
...
export default BookPackageView;
